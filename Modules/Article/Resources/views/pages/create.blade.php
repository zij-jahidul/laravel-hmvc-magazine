                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group has-success">
                                            ...
                                            <select class="form-control custom-select" id="phone_visible"
                                                ...
                                                <option value="0"
                                                    {{ old('phone_visible') === 0 ? 'selected' : null }}>
                                                    No
                                                </option>
                                                <option value="1"
                                                    {{ old('phone_visible') === 1 ? 'selected' : null }}>
                                                    Yes
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" id="is_position"
                                                    ...
                                                    <option value="0"
                                                        {{ old('is_position') === 0 ? 'selected' : null }}>
                                                        Pending
                                                    </option>
                                                    <option value="1"
                                                        {{ old('is_position') === 1 ? 'selected' : null }}>
                                                        Approve
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="meta_description" name="meta_description"
                                                value="{{ old('meta_description') }}" placeholder="Meta description for SEO"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <select class="form-control custom-select" id="is_phone_visible"
                                            ...
                                            <option value="false"
                                                {{ old('is_phone_visible') === 'false' ? 'selected' : null }}>
                                                No
                                            </option>
                                            <option value="true"
                                                {{ old('is_phone_visible') === 'true' ? 'selected' : null }}>
                                                Yes
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="address">Address<span
                                                class="required">*</span></label>
                                        <textarea type="text" class="form-control" id="address" name="address" value="{{ old('address') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="additional_info_title" name="additional_info_title"
                                            value="{{ old('additional_info_title') }}" placeholder="Meta description for SEO"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control tinymce_advance" id="additional_info_description"
                                            name="additional_info_description" value="{{ old('additional_info_description') }}"></textarea>
                                    </div>
                                </div>
