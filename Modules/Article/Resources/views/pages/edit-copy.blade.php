                ...
                <div class="form-body">
                    <div class="card-body">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="number" class="form-control" id="priority" name="priority"
                                            value="{{ $page->priority }}" placeholder="Priority" />
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        @if ($user->can('admin.view') || $user->can('admin.create'))
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <select class="form-control custom-select" id="phone_visible" name="phone_visible"
                                            required>
                                            <option value="0" {{ $page->phone_visible === 0 ? 'selected' : null }}>
                                                No
                                            </option>

                                            <option value="1" {{ $page->phone_visible === 1 ? 'selected' : null }}>
                                                Yes
                                            </option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" for="article_type_id">Approve Status</label>
                                        <br>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <select class="form-control custom-select" id="is_position" name="is_position"
                                            required>
                                            <option value="0" {{ $page->is_position === 0 ? 'selected' : null }}>
                                                Pending
                                            </option>
                                            <option value="1" {{ $page->is_position === 1 ? 'selected' : null }}>
                                                Approve
                                            </option>
                                        </select>
                                    </div>
                    ...
                    @if (request()->type === 'advertisement')
                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address"
                                            value="{{ $advertisement->address }}" placeholder="Enter Title"
                                            required="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="poster_image">Article Banner Image <span
                                            class="optional">(optional)</span></label>
                                    <input type="file" class="form-control dropify" data-height="70"
