                    ...
                    <div class="row ">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                @if ($page->image != null)
                                    <img src="{{ asset('public/assets/images/pages/' . $page->image) }}" alt="Image"
                                        class="img width-100" />
                                @else
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="banner_image">Poster Image</label>
                                <br>
                                @if ($page->poster_image != null)
                                    <img src="{{ asset('public/assets/images/pages/' . $page->poster_image) }}"
                                        alt="Image" class="img img-display-list" />
                                @else
                                    <span class="border p-2">
                                        No Image
                                    </span>
