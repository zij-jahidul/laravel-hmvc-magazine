                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="title">Catalog Title <span
                            ...
                            <div class="col-md-2">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $service->status === 1 ? 'selected' : null }}>Active
                                        </option>
                                        <option value="0" {{ $service->status === 0 ? 'selected' : null }}>Inactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" data-height="70"
                                        ...
                                        data-default-file="{{ $service->image != null ? asset('public/assets/images/services/' . $service->image) : null }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="banner_image">Catalog Banner Image <span
                                            class="optional">(optional)</span></label>
                                    <input type="file" class="form-control dropify" data-height="70"
                                        data-allowed-file-extensions="png jpg jpeg webp" id="banner_image"
                                        name="banner_image"
                                        data-default-file="{{ $service->banner_image != null ? asset('public/assets/images/services/' . $service->banner_image) : null }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="meta_description">Catalog Meta Description <span
                                            class="optional">(optional)</span></label>
