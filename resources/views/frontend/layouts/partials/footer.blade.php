  <!-- Footer -->
  <footer id="footer" class="bg-color-secondary border-0 mt-0 footer-reveal">
          ...
          <div class="row py-5">
              <div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
                  ...
                  <ul class="list list-unstyled mb-0">
                      ...
                      <li>
                          <a href="mailto:{!! $settings->contact->email_primary !!}">{!! $settings->contact->email_primary !!}</a>
                      </li>
                      <li>
                  ...
                  <div class="feature-box feature-box-style-2 align-items-center mb-3">
                      <div class="feature-box-icon">
                          <div class="animated-icon animated fadeIn svg-fill-color-light">
                              <!--?xml version="1.0" ?--><svg style="enable-background:new 0 0 512 512;" version="1.1"
                                  viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                  xmlns:xlink="http://www.w3.org/1999/xlink" id="icon_171625898378546"
                                  data-filename="phone.svg" width="45" height="45">
                                  <style type="text/css">
                                      .st0 {
                                          fill: #333333;
                                      }
              ...
              <div class="col-md-4 col-lg-4 mb-4 mb-md-0">
                  <h4 class="font-weight-bold ls-0">Catalogs</h4>
                  @php
                      $services = \Modules\Service\Entities\Service::get();
                  @endphp
                  ...
                  <a href="{{ route('service') }}"
                      class="btn btn-link font-weight-bold text-decoration-none ps-0">VIEW MORE</a>
              </div>
              <div class="col-md-4 col-lg-2 mb-4 mb-md-0">
                  ...
                  <ul class="list-unstyled mb-0">
                      ...
                      <li class="mb-0">
                          <a href="{{ route('blog') }}">News and Stories</a>
                      </li>
                  </ul>
              </div>
              <div class="col-md-4 col-lg-2">
                  ...
                  {{-- <div class="mt-3">
                      ...
                      <img src="{{ asset('public/modules/theme-business/images/common/payment-methods.jpg') }}"
                          style="width: 250px;" />
                  </div> --}}
              </div>
          </div>
